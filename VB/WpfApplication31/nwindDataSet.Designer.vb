...
Namespace WpfApplication31
    ...
    Partial Public Class nwindDataSet
        ...
        Friend Sub InitVars(ByVal initTable As Boolean)
            Me.tableCustomerReports = (DirectCast(MyBase.Tables("CustomerReports"), CustomerReportsDataTable))
        ...
        Partial Public Class CustomerReportsRow
            ...
            Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
                MyBase.New(rb)
                Me.tableCustomerReports = (DirectCast(Me.Table, CustomerReportsDataTable))
            End Sub
